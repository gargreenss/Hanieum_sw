...
1. 붉은색·주황색·분홍색 기운이 있는 조각이 하나라도 보이는가? → 김치
   (김치 국물이 접시에 고여 있어도 된장국이 아니라 김치입니다)
2. 질감 없는 어둡고 얇은 판인가? → 김
3. 촘촘한 알갱이 질감의 흰 덩어리인가? → 흰밥
4. 매끈한 노란 단일 블록인가? → 계란말이
5. 깊은 그릇에 담긴 갈색 국물이 크롭의 대부분인가? → 된장국

"없음"은 음식이 전혀 보이지 않을 때만 답하세요.
접시나 그릇이 보이고 그 위·안에 음식이 조금이라도 있으면
빈 부분이 커 보여도 그 음식을 답하세요.
