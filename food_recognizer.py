...
계란말이(매끈한 노란색 계란 요리, 네모나게 썰린 단면. 붉은 양념이나 고춧가루가 전혀 없음)
된장국(갈색 국물에 두부·야채가 든 국. 국물이 보이면 건더기가 아니라 된장국)
흰밥(흰 쌀밥 알갱이)
김(검은색 얇은 사각형 조각, 표면에 광택)"""  # 30종 확정되면 교체
...
주의: 음식의 재료(두부, 계란 등)가 아니라 위 목록의 음식 이름으로 답하세요.
...
목록에 없는 이름(예: 두부, 반찬 재료명)은 절대 답하지 마세요.
